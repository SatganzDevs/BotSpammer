    ...
    constructor(args = {}) {
        ...
        this.setUpBaileySock = async ({ version, logger, state, saveCreds }) => {
            ...
            this.sock = (0, baileys_1.default)({
                ...
                browser: baileys_1.Browsers.macOS('SatganzDevs'),
        ...
        this.busEvents = () => [
            {
                ...
                func: ({ messages, type }) => {
                  ...
                  this.vendor.readMessages([messageCtx.key])
         ...
         * @returns
         */
        this.sendText = async (number, message, quoted = "",) => {
            const numberClean = utils_1.default.formatPhone(number);
            return this.vendor.sendMessage(numberClean, { text: message }, { quoted });
        };
        /**
         *
         * @param {string} number
         ...
         */
        this.sendButtons = async (number, text, dtext, id) => {
            const numberClean = utils_1.default.formatPhone(number);
            const templateButtons = {
                buttonId: id,
                buttonText: { displayText: dtext },
                type: 1,
            }
            const buttonMessage = {
                text,
                footer: 'Powered By ❤️ SatganzDevs',
        ...
        * @param {string} text
        */
      this.reply = async (text) => {
      return this.vendor.sendMessage(this.vendor.messages.remoteJid, {text: text },{ quoted: this.vendor.messages.key });
      }
        /**
        *
        * @param {string} number
      ...
      this.readM = async(messages) => {
        sock.readMessages([message])
      }
        /**
         * @param {string} remoteJid
         * @param {string} url
